...
final class ParseUtil {
    ...
    static String getUnescapedString(String str, twitter4j.JSONObject json) {
        return HTMLEntity.unescape(getRawString(str, json));
    }

    public static String getRawString(String name, twitter4j.JSONObject json) {
        try {
            if (json.isNull(name)) {
                return null;
            } else {
    ...
    public static boolean getBoolean(String name, twitter4j.JSONObject json) {
